...
CREATE UNIQUE INDEX `anime_slug_unique` ON `anime` (`slug`);
...
CREATE UNIQUE INDEX `episodes_anime_id_episode_number_unique` ON `episodes` (`anime_id`,`episode_number`);
...
CREATE UNIQUE INDEX `franchises_name_unique` ON `franchises` (`name`);
