...
import { Mail, ArrowRight, Github, Play } from 'lucide-vue-next'
        ...
        <div v-if="!isSent">
          ...
          <div class="mt-8 pt-8 border-t border-white/5">
            ...
            <div class="grid grid-cols-1 gap-4">
              <button class="flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-white/5 rounded-xl py-4 transition-all group">
